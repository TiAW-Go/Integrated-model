...
parser.add_argument('--datapath', type=str, default='one.csv.gz', help='Testing dataset path')
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        for i_batch, batch in enumerate(dataloader):
            if args.cuda:
                batch = [tensor.cuda() for tensor in batch]#获取一个目标
            ...
            batch_outputs.append(batch_output)#在列表尾部再添加一个元素

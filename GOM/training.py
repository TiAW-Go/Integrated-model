...
for system in systems:
    ...
    if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
        ...
        train_data = TestbedDataset(root='data', dataset=system+'_train')
        test_data = TestbedDataset(root='data', dataset=system+'_test')
        ...
        best_ci = 0
        best_epoch = -1
        model_file_name = 'model_' + model_st + '_' + system + '.model'
        result_file_name = 'result_' + model_st + '_' + system + '.csv'
        ...
        for epoch in range(NUM_EPOCHS):
            ...
            if ret[1] < best_mse:
                ...
                print('rmse improved at epoch ', best_epoch,
                      '; best_mse,best_ci:', best_mse, best_ci, model_st, system)
            else:

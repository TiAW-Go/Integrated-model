...
parser.add_argument('--evaluate', action='store_true', default=True, help='specify it to be true if you want to do evaluation on test set (available only when test labels are provided)')

...
parser.add_argument('--pro_dataset_path', type=str, default="../../datasets/moleculenet_pre/", help='directory of the preprocessed data (Pytorch Geometric Data)')
...
parser.add_argument('--model_dir', type=str, default='../trained_models/qm8/', help='directory of the trained model')

...
parser.add_argument('--split_ready', action='store_true', default=True, help='specify it to be true if you provide three files for train/val/test')
####################################################################

### (1) The following arguments are used when split_ready==False.###
parser.add_argument('--testfile', type=str, default='/home/aita/4444/east/moleculekit/model/prediction_dataset/qm8.qt',help='path to the preprocessed test file (Pytorch Geometric Data)')
####################################################################

### (2) The following arguments are used when split_ready==True.###
parser.add_argument('--ori_dataset_path', type=str, default="/home/aita/4444/east/moleculekit/model/prediction_dataset/", help='directory of the original csv file (SMILES string)')
parser.add_argument('--pro_dataset_path', type=str, default="/home/aita/4444/east/moleculekit/model/prediction_dataset/", help='directory of the preprocessed data (Pytorch Geometric Data)')
parser.add_argument('--split_mode', type=str, default='random', help=' split methods, use random, stratified or scaffold')
parser.add_argument('--split_train_ratio', type=float, default=0, help='the ratio of data for training set')
parser.add_argument('--split_valid_ratio', type=float, default=0, help='the ratio of data for validation set')
parser.add_argument('--split_seed', type=int, default=122, help='random seed for split, use 122, 123 or 124')
####################################################################

parser.add_argument('--model_dir', type=str, default='/home/aita/4444/east/moleculekit/model/graph/trained_models/', help='directory of the trained model')
parser.add_argument('--save_pred', action='store_true', default=True, help='save prediction result or not')

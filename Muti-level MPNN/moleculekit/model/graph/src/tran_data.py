...
parser.add_argument('--ori_dataset_path', type=str, default="/home/aita/4444/east/moleculekit/model/prediction_dataset/") ### Directory of original data (csv files)
parser.add_argument('--dataset', type=str, default="qm8")
parser.add_argument('--pro_dataset_path', type=str, default="/home/aita/4444/east/moleculekit/model/prediction_dataset/") ### Directory to save the processed data.
...
parser.add_argument('--junction_tree', type=bool, default=True) ### generate junction tree (subgraph) or not
...
torch.save(graph_set, args.pro_dataset_path + args.dataset + '.qt')
